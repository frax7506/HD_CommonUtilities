...
template<>
void TestUtils::Vector2_AreEqual(const HD_Vector2_f32& aVector, f32 aX, f32 aY)
{
...
template<>
void TestUtils::Vector3_AreEqual(const HD_Vector3_f32& aVector, f32 aX, f32 aY, f32 aZ)
{
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aVector.myX, aX, F32_EQUAL_TOLERANCE);
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aVector.myY, aY, F32_EQUAL_TOLERANCE);
...
template<>
void TestUtils::Vector4_AreEqual(const HD_Vector4_f32& aVector, f32 aX, f32 aY, f32 aZ, f32 aW)
{
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aVector.myX, aX, F32_EQUAL_TOLERANCE);
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aVector.myY, aY, F32_EQUAL_TOLERANCE);
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aVector.myZ, aZ, F32_EQUAL_TOLERANCE);
...
template<>
void TestUtils::Matrix3x3_AreEqual(const HD_Matrix3x3_f32& aMatrix, f32 a11, f32 a12, f32 a13, f32 a21, f32 a22, f32 a23, f32 a31, f32 a32, f32 a33)
{
...
template<>
void TestUtils::Matrix4x4_AreEqual(const HD_Matrix4x4_f32& aMatrix, f32 a11, f32 a12, f32 a13, f32 a14, f32 a21, f32 a22, f32 a23, f32 a24, f32 a31, f32 a32, f32 a33, f32 a34, f32 a41, f32 a42, f32 a43, f32 a44)
{
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aMatrix.m11, a11, F32_EQUAL_TOLERANCE);
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aMatrix.m12, a12, F32_EQUAL_TOLERANCE);
	Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(aMatrix.m13, a13, F32_EQUAL_TOLERANCE);
