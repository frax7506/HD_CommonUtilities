...
namespace HD_CommonUtilities
{
	...
	public:
		...
		TEST_METHOD(Length)
		{
			HD_Vector4f f32Vector(1.f, 1.f, 1.f, 1.f);
		...
		TEST_METHOD(Length2)
		{
			...
			HD_Vector4s s32Vector(2, 2, 2, 2);
			s32 s32Length2 = s32Vector.Length2();
			Assert::AreEqual(s32Length2, 16);

			HD_Vector4u u32Vector(3u, 3u, 3u, 3u);
		...
		{
			HD_Vector4f f32Vector(2.f, 2.f, 2.f, 2.f);
			f32Vector.Normalize();
			f32 length = f32Vector.Length();
		...
		{
			HD_Vector4f f32Vector(2.f, 2.f, 2.f, 2.f);
			HD_Vector4f normalizedf32Vector = f32Vector.GetNormalized();
		...
		{
			HD_Vector4f f32Vector1(1.f, 2.f, 3.f, 4.f);
			HD_Vector4f f32Vector2;
			f32Vector2 = f32Vector1;
			TestUtils::Vector4_AreEqual(f32Vector2, 1.f, 2.f, 3.f, 4.f);

			HD_Vector4s s32Vector1(5, 6, 7, 8);
			HD_Vector4s s32Vector2;
			s32Vector2 = s32Vector1;
			TestUtils::Vector4_AreEqual(s32Vector2, 5, 6, 7, 8);

			HD_Vector4u u32Vector1(9u, 10u, 11u, 12u);
			HD_Vector4u u32Vector2;
		...
		{
			HD_Vector4f f32Vector1(1.f, 2.f, 3.f, 4.f);
			HD_Vector4f f32Vector2(5.f, 6.f, 7.f, 8.f);
			f32Vector1 += f32Vector2;
			TestUtils::Vector4_AreEqual(f32Vector1, 6.f, 8.f, 10.f, 12.f);

			HD_Vector4s s32Vector1(1, 2, 3, 4);
			HD_Vector4s s32Vector2(5, 6, 7, 8);
			s32Vector1 += s32Vector2;
			TestUtils::Vector4_AreEqual(s32Vector1, 6, 8, 10, 12);

			HD_Vector4u u32Vector1(1u, 2u, 3u, 4u);
			HD_Vector4u u32Vector2(5u, 6u, 7u, 8u);
		...
		TEST_METHOD(Operator_MinusEquals)
		{
			...
			HD_Vector4u u32Vector1(5u, 6u, 7u, 8u);
			HD_Vector4u u32Vector2(1u, 2u, 3u, 4u);
			u32Vector1 -= u32Vector2;
		...
		TEST_METHOD(Operator_MultiplicationEquals)
		{
			...
			HD_Vector4s s32Vector(1, 2, 3, 4);
			s32Vector *= 2;
			TestUtils::Vector4_AreEqual(s32Vector, 2, 4, 6, 8);

			HD_Vector4u u32Vector(1u, 2u, 3u, 4u);
			u32Vector *= 2u;
		...
		TEST_METHOD(Operator_Plus)
		{
			HD_Vector4f f32Vector1(1.f, 2.f, 3.f, 4.f);
			HD_Vector4f f32Vector2(5.f, 6.f, 7.f, 8.f);
			HD_Vector4f f32VectorResult = f32Vector1 + f32Vector2;
			TestUtils::Vector4_AreEqual(f32VectorResult, 6.f, 8.f, 10.f, 12.f);

			HD_Vector4s s32Vector1(1, 2, 3, 4);
			HD_Vector4s s32Vector2(5, 6, 7, 8);
			HD_Vector4s s32VectorResult = s32Vector1 + s32Vector2;
			TestUtils::Vector4_AreEqual(s32VectorResult, 6, 8, 10, 12);

			HD_Vector4u u32Vector1(1u, 2u, 3u, 4u);
			HD_Vector4u u32Vector2(5u, 6u, 7u, 8u);
			HD_Vector4u u32VectorResult = u32Vector1 + u32Vector2;
		...
		{
			HD_Vector4f f32Vector(1.f, 2.f, 3.f, 4.f);
			HD_Vector4f f32VectorResult = f32Vector * 2.f;
			TestUtils::Vector4_AreEqual(f32VectorResult, 2.f, 4.f, 6.f, 8.f);

			HD_Vector4s s32Vector(1, 2, 3, 4);
			HD_Vector4s s32VectorResult = s32Vector * 2;
			TestUtils::Vector4_AreEqual(s32VectorResult, 2, 4, 6, 8);

			HD_Vector4u u32Vector(1u, 2u, 3u, 4u);
			HD_Vector4u u32VectorResult = u32Vector * 2u;
		...
		{
			HD_Vector4f f32Vector(1.f, 2.f, 3.f, 4.f);
			HD_Vector4f f32VectorResult = 2.f * f32Vector;
			TestUtils::Vector4_AreEqual(f32VectorResult, 2.f, 4.f, 6.f, 8.f);

			HD_Vector4s s32Vector(1, 2, 3, 4);
			HD_Vector4s s32VectorResult = 2 * s32Vector;
			TestUtils::Vector4_AreEqual(s32VectorResult, 2, 4, 6, 8);

			HD_Vector4u u32Vector(1u, 2u, 3u, 4u);
			HD_Vector4u u32VectorResult = 2u * u32Vector;
			TestUtils::Vector4_AreEqual(u32VectorResult, 2u, 4u, 6u, 8u);
		}
